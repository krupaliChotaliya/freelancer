...
import com.freelancer.app.models.Message;
...
import com.freelancer.app.services.MessageService;
...
public class MessageController extends AbstractController {
	...
	public String jobRoom(Model model, 
		...
		if( job != null){
			...
			//TODO: make change: find message based on senderID, receiverID, JobID
