...
import com.freelancer.app.services.FeedbackService;
...
import com.freelancer.app.models.JobHistory;
import com.freelancer.app.models.Profile;
...
public class ProfileController extends AbstractController {
    ...
    public String saveProfile(@ModelAttribute @Valid User user, @ModelAttribute Profile profile, Model model){
		...
		if (me.getProfile() != null) {
            ...
            me.getProfile().setSkills(profile.getSkills());
		} else {
